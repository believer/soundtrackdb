...
module Enum_SoundtrackComposersOrderBy: {
  type t = [
    ...
    | `SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_ASC
    | `SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_DESC
  ...
  let unwrap = wrapped =>
    ...
    | "SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_ASC" => `SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_ASC
    | "SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_DESC" => `SOUNDTRACK_BY_SOUNDTRACK_ID__RELEASE_YEAR_DESC
